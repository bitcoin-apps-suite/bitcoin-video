...
export default function BitcoinVideo() {
  ...
  const videos: Video[] = [
    ...
    {
      id: '3',
      title: 'Ethereum vs Solana rap battle (streamed live on Bitcoin SV)',
    ...
    {
      id: '5',
      title: 'POV: You\'re debating Layer 2s while Layer 1 already works',
