...
export default function BitcoinVideo() {
  ...
  const videos: Video[] = [
    {
      id: '1',
      title: 'Bitcoin Hits New ATH - Live Market Analysis',
    ...
    {
      id: '2',
      title: 'How Lightning Network Changes Everything - Beginner Guide',
      thumbnail: '/api/placeholder/320/180',
      channel: 'BTCEducation',
      views: '128K',
    ...
    {
      id: '3',
      title: 'AI-Generated: Daily Bitcoin Technical Analysis',
      thumbnail: '/api/placeholder/320/180',
      channel: 'AutoTrader Bot',
      views: '89K',
    ...
    {
      id: '4',
      title: 'Michael Saylor Interview - Why Bitcoin to $1M',
      thumbnail: '/api/placeholder/320/180',
    ...
    {
      id: '5',
      title: 'Setting Up Your First Bitcoin Node - Complete Tutorial',
      thumbnail: '/api/placeholder/320/180',
      channel: 'NodeRunners',
      views: '67K',
    ...
    {
      id: '6',
      title: 'AI Analysis: Whale Movements & Price Predictions',
      thumbnail: '/api/placeholder/320/180',
      channel: 'CryptoAI Analytics',
      views: '156K',
    ...
    {
      id: '7',
      title: 'Bitcoin Mining in 2024 - Is It Still Profitable?',
      thumbnail: '/api/placeholder/320/180',
      channel: 'MiningMasters',
      views: '203K',
    ...
    {
      id: '8',
      title: 'Understanding Bitcoin Halving Cycles',
      thumbnail: '/api/placeholder/320/180',
      channel: 'CryptoClassroom',
      views: '345K',
