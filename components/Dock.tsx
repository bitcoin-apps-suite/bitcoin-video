...
import { Wallet, Mail, Music, FileText, HardDrive, Calendar, Search, Table, Share2, Briefcase, Store, Wifi, Battery, Clock, TrendingUp, Building2, Shield, Video, Code2, Camera, MapPin, MessageCircle, Users, Gamepad2, BookOpen, Globe, Box, Monitor, GraduationCap, Paintbrush, UserCheck, Maximize2, Home, Sparkles, Minimize2 } from 'lucide-react';
import './Dock.css';
...
const Dock: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const savedDockStyle = localStorage.getItem('dockStyle') as 'minimal' | 'large' || 'minimal';
  ...
  // Special right-side mini icons for minimal dock
