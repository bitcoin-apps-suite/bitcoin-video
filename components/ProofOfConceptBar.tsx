  ...
  return (
    <div className="poc-banner">
      <div className="poc-banner-mobile-container">
          ...
          <div className="poc-banner-text">
            <div className="poc-banner-message">
              <div className="poc-banner-line1">
                <strong>PROOF OF CONCEPT:</strong> This is a demonstration version of Bitcoin Video.
              </div>
        ...
        {/* Features Link */}
        <a href="/features" className="poc-banner-link">
        ...
        {/* Create Link */}
        <a href="/create" className="poc-banner-link">
          <svg height="14" width="14" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* Exchange Link */}
        <a href="/exchange" className="poc-banner-link">
          <svg height="14" width="14" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* Twitter Link */}
        <a
          href="https://twitter.com/bitcoin_video"
          target="_blank"
          rel="noopener noreferrer"
          className="poc-banner-link"
        >
