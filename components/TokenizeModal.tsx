      ...
      <div className="tokenize-modal">
        ...
        <div className="modal-body">
          ...
          <div className="document-info-box">
            <h3>🎬 {videoTitle || 'Untitled Video'}</h3>
            <p>{Math.floor(videoDuration / 60)}:{(videoDuration % 60).toString().padStart(2, '0')} • {(videoSize / (1024 * 1024)).toFixed(1)}MB • Ready for tokenization</p>
          </div>
