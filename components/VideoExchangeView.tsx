...
interface VideoListing {
  ...
  marketCap: number;
  contentType: 'short' | 'documentary' | 'tutorial' | 'entertainment' | 'live-stream';
  genre: string;
  tags: string[];
  txId: string;
  trending?: boolean;
...
interface CreatorListing {
  ...
  twitter?: string;
  creatorType: 'human' | 'ai';
  category?: 'all' | 'humans' | 'ais' | 'filmmakers' | 'educators' | 'entertainers' | 'documentarians' | 'reviewers' | 'gamers' | 'musicians';
  joinDate: string;
  totalVideos: number;
  totalViewers: number;
  totalRevenue: number;
